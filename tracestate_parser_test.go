...
func TestEmptyTracestate(t *testing.T) {
	...
	if parsedState.isValid() != false {
		t.Errorf("Expected parsed state to be invalid")
	}
	if parsedState.version != nil {
		t.Errorf("Expected version to be nil, got %v", *parsedState.version)
	}
	if parsedState.rValue32 != nil {
		t.Errorf("Expected rValue32 to be nil, got %v", *parsedState.rValue32)
	}
	if parsedState.rValue64 != nil {
		t.Errorf("Expected rValue64 to be nil, got %v", *parsedState.rValue64)
	}
}
...
func TestTracestateNoVersion64(t *testing.T) {
	...
	if *parsedState.rValue64 != uint64(1234) {
		t.Errorf("Expected rValue64 to be %v, got %v", uint64(1234), *parsedState.rValue64)
	}
}
...
func TestTracestateNoVersion32(t *testing.T) {
	...
	if *parsedState.rValue32 != uint32(1234) {
		t.Errorf("Expected rValue32 to be %v, got %v", uint32(1234), *parsedState.rValue32)
	}
	if parsedState.rValue64 != nil {
		t.Errorf("Expected rValue64 to be nil, got %v", *parsedState.rValue64)
	}
...
func TestTracestateNoRValue(t *testing.T) {
	...
	if *parsedState.version != "1" {
		t.Errorf("Expected version to be '1', got %v", *parsedState.version)
	}
	if parsedState.rValue32 != nil {
		t.Errorf("Expected rValue32 to be nil, got %v", *parsedState.rValue32)
	}
...
func TestTracestateFull64(t *testing.T) {
	...
	if parsedState.isValid() == false {
		t.Errorf("Expected parsed state to be valid")
	}
	if *parsedState.version != "2" {
		t.Errorf("Expected version to be '2', got %v", *parsedState.version)
	}
	if parsedState.rValue32 != nil {
		t.Errorf("Expected rValue32 to be nil, got %v", *parsedState.rValue32)
	}
	if *parsedState.rValue64 != uint64(999) {
		t.Errorf("Expected rValue64 to be 999, got %v", *parsedState.rValue64)
	}
	if parsedState.isValue32() == true {
		t.Errorf("Expected isValue32 to be false")
	}
	if parsedState.getRValue64() != uint64(999) {
		t.Errorf("Expected getRValue64 to be 999, got %v", parsedState.getRValue64())
	}
}
...
func TestTracestateFull32(t *testing.T) {
	...
	if *parsedState.rValue32 != uint32(999) {
		t.Errorf("Expected rValue32 to be 999, got %v", *parsedState.rValue32)
	}
	if parsedState.rValue64 != nil {
		t.Errorf("Expected rValue64 to be nil, got %v", *parsedState.rValue64)
	}
	if parsedState.isValue32() == false {
		t.Errorf("Expected isValue32 to be true")
	}
	if parsedState.getRValue32() != uint32(999) {
		t.Errorf("Expected getRValue32 to be 999, got %v", parsedState.getRValue32())
	}
}
